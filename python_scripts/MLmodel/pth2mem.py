...
if __name__ == '__main__':
    ...
    layer4 = torch.cat((i_gate_i, i_gate_h,i_gate_b), dim=1).to(torch.int16)
    layer5 = torch.cat((f_gate_i, f_gate_h,f_gate_b), dim=1).to(torch.int16)
    layer6 = torch.cat((g_gate_i, g_gate_h,g_gate_b), dim=1).to(torch.int16)
    layer7 = torch.cat((o_gate_i, o_gate_h,o_gate_b), dim=1).to(torch.int16)
