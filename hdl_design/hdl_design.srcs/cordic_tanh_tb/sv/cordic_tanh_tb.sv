...
module cordic_tanh_tb();
	...
	`else
	    $readmemh("./hdl_design/hdl_design.srcs/cordic_tanh_tb/cordic_afb_inputs.mem", input_test_vals);
	    $readmemh("./hdl_design/hdl_design.srcs/cordic_tanh_tb/cordic_afb_outputs.mem", output_test_vals);
	`endif
    end
