module relu_tb();
    ...
    logic [$clog2(L2)-1:0] output_counter_n, output_counter_r;
    logic [N-1:0] input_test_vals [L1-1:0];
    ...
    assign input_counter_n = (valid_i && ready_o) && (input_counter_r != (L1)) ? 
        input_counter_r + 1 : input_counter_r;
    assign output_counter_n = valid_o && yumi_i && (output_counter_r != (L2)) ? 
        output_counter_r + 1 : output_counter_r;
    
    // Create an LFSR to assign other two ready and valid signals
    // this makes things more robust
